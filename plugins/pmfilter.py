...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.answer('𝚂𝚄𝚁𝙿𝚁𝙸𝚂𝙴')
    elif query.data == "start":
        buttons = [[
            InlineKeyboardButton('𝚂𝚄𝚁𝙿𝚁𝙸𝚂𝙴', callback_data='unda')
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons= [[
            ...
            InlineKeyboardButton('🕸️𝚂𝚃𝙰𝚃𝚄𝚂🕸️', callback_data='stats'),
            InlineKeyboardButton('♧HOME♧', callback_data='unda')
        ]]  
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(                     
            text=script.HELP_TXT.format(query.from_user.mention),
        ...
        buttons= [[
            InlineKeyboardButton('⊛𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴⊛', callback_data='sourc'),
            InlineKeyboardButton('🕸️𝚂𝚃𝙰𝚃𝚄𝚂🕸️', callback_data='stats')
            ],[
            InlineKeyboardButton('✹𝙷𝙴𝙻𝙿✹', callback_data='help'),
            ],[
            InlineKeyboardButton('♧𝙷𝙾𝙼𝙴♧', callback_data='unda'),
            InlineKeyboardButton('✼𝙲𝙻𝙾𝚂𝙴✼', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="▰▱▱▱▱▱▱▱▱▱ 10%"
        ...
        buttons = [[
            InlineKeyboardButton('𝙱𝙰𝙲𝙺', callback_data='3')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
